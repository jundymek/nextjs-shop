...
export type GetProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, price: number, description: string, slug: string, images: Array<{ __typename?: 'Asset', url: string }> }>, productsConnection: { __typename?: 'ProductConnection', aggregate: { __typename?: 'Aggregate', count: number } } };
...
export type GetProductDetailsBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', slug: string, name: string, price: number, description: string, reviews: Array<{ __typename?: 'Review', rating?: number | null }>, images: Array<{ __typename?: 'Asset', id: string, url: string }> } | null };
...
export type GetProductsPaginateQueryVariables = Exact<{
...
export const GetProductsPaginateDocument = gql`
...
/**
 * __useGetProductsPaginateQuery__
 *
 * To run a query within a React component, call `useGetProductsPaginateQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductsPaginateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductsPaginateQuery({
 *   variables: {
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetProductsPaginateQuery(baseOptions?: Apollo.QueryHookOptions<GetProductsPaginateQuery, GetProductsPaginateQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductsPaginateQuery, GetProductsPaginateQueryVariables>(GetProductsPaginateDocument, options);
      }
export function useGetProductsPaginateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductsPaginateQuery, GetProductsPaginateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductsPaginateQuery, GetProductsPaginateQueryVariables>(GetProductsPaginateDocument, options);
        }
export type GetProductsPaginateQueryHookResult = ReturnType<typeof useGetProductsPaginateQuery>;
export type GetProductsPaginateLazyQueryHookResult = ReturnType<typeof useGetProductsPaginateLazyQuery>;
export type GetProductsPaginateQueryResult = Apollo.QueryResult<GetProductsPaginateQuery, GetProductsPaginateQueryVariables>;
 ...
 * });
 */
export function useGetProductReviewsBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>(GetProductReviewsBySlugDocument, options);
      }
export function useGetProductReviewsBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>(GetProductReviewsBySlugDocument, options);
        }
export type GetProductReviewsBySlugQueryHookResult = ReturnType<typeof useGetProductReviewsBySlugQuery>;
export type GetProductReviewsBySlugLazyQueryHookResult = ReturnType<typeof useGetProductReviewsBySlugLazyQuery>;
export type GetProductReviewsBySlugQueryResult = Apollo.QueryResult<GetProductReviewsBySlugQuery, GetProductReviewsBySlugQueryVariables>;