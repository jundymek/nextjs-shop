...
export type GetProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', name: string, price: number, description: string, slug: string, images: Array<{ __typename?: 'Asset', url: string }> }> };
